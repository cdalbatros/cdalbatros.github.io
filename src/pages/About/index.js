...
const About = () => {
  ...
  return (
    <PageLayout>
      ...
      <Section>
        <div className='text-container'>
        <h2 className='large-text'>Hacer del club una institución reconocida en el medio por su continuo mejoramiento y rendimiento deportivo en las distintas disciplinas. Contando con un gimnasio y una gestión moderna, que considere a sus colaboradores y proveedores.</h2>
        </div>
      </Section>
